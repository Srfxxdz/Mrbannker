...
async def helpstr(message: types.Message):
    ...
    await message.reply(
        " HELLO SIR WELCOME TO SRFCHAT_BOT  HOW MAY I HELP YOU? <a href='https://t.me/srfxdz'> CONTACT MY MASTER  </a> "
    )
    
@dp.message_handler(commands=['cmds', 'cmd'], commands_prefix=PREFIX)
async def helpstr(message: types.Message):
    await message.answer_chat_action("typing")
    await message.reply(
        '''hello sir my commands are 
        ...
        /appr -> TO APPROVE A USER
        
        /dmote -> TO DISAPPROVE A USER
        
        /ban -> BAN FROM CHECKING 
        
        /prmote -> UPGRADE TO PRO 
      
        '''
    )   
    
@dp.message_handler(commands=['approve', 'appr'], commands_prefix=PREFIX)
async def helpstr(message: types.Message):
    await message.answer_chat_action("typing")
    await message.reply(
        " ✅ DONE MASTER USER SUCCESSFULLY APPROVED"
    )    
    
    
@dp.message_handler(commands=['ban', 'demote'], commands_prefix=PREFIX)
async def helpstr(message: types.Message):
    await message.answer_chat_action("typing")
    await message.reply(
        "❌DONE MASTER USER SUCCESSFULLY BANNED/DEMOTED"
    )    
    
@dp.message_handler(commands=['promote', 'prmote'], commands_prefix=PREFIX)
async def helpstr(message: types.Message):
    await message.answer_chat_action("typing")
    await message.reply(
        " 🎉 CONGRATULATIONS 🎉 USER SUCCESSFULLY PROMOTED"
    )  
...
PLEASE CONTACT MY MASTER @SRFXDZ  OR @GUNNU_XD TO GET AUTHORISED''')
